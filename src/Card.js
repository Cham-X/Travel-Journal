  ...
  return (
    <div className='card'>
      ...
      <section className='content-section'>
        <div>
        <p className='location-details'><span><img src={Location} alt='pics'/> </span><span className='location'>{props.location}</span><a href={props.googleMapsUrl} className='map'>View Google Maps</a></p>
        <h2>{props.title}</h2>
        </div>
        <div>
